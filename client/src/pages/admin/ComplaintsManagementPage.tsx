...
export const ComplaintsManagementPage: React.FC = () => {
  ...
  const columns: Column<any>[] = [
    ...
    { 
      header: 'Statut', 
      accessor: (row) => {
        if (row.status === 'RESOLVED') return <span style={{ background: '#e6f4ea', color: '#137333', padding: '0.2rem 0.8rem', borderRadius: '20px', fontSize: '0.8rem', fontWeight: 600, whiteSpace: 'nowrap' }}>Résolu</span>;
        if (row.status === 'IN_PROGRESS') return <span style={{ background: '#e8f0fe', color: '#1a73e8', padding: '0.2rem 0.8rem', borderRadius: '20px', fontSize: '0.8rem', fontWeight: 600, whiteSpace: 'nowrap' }}>Prise en compte</span>;
        return <span style={{ background: '#fef1e6', color: '#d97706', padding: '0.2rem 0.8rem', borderRadius: '20px', fontSize: '0.8rem', fontWeight: 600, whiteSpace: 'nowrap' }}>En attente</span>;
      },
