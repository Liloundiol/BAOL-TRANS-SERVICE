...
router.get('/', (0, authMiddleware_1.requireRole)(['ADMIN', 'AGENT']), packageController_1.getPackages);
router.post('/', (0, authMiddleware_1.requireRole)(['ADMIN', 'AGENT']), packageController_1.createPackage);
